package com.hrawat.theicyphoenix.activity.utils;
...
public final class BitmapUtils {
    ...
    private static final String TEMP_IMG_DIRECTORY = "TheIcyPhoenix";
    private static final String IMG_EXTENSION = ".jpg";
    public static final int DEFAULT_PHOTO_WIDH = 540;
    public static final int DEFAULT_PHOTO_HEIGHT = 760;
    ...
    public static String generateThumbnail(String path, int width, int height) {
        try {
            ...
            Log.d(TAG, "generateThumbnailError "+e);
        }
        return null;
    }
